...
public class UploadFilePopup extends VBox {
    ...
    public String getFileType() {
        return fileTypeCombo.getValue();
    }

    public String getCourse() {
        return courseCombo.getValue();
    }

    public String getVisibility() {
        return visibilityCombo.getValue();
    }
    ...
    public void lockVisibility(String visibility) {
        if (visibilityCombo.getItems().contains(visibility)) {
            visibilityCombo.setValue(visibility);
